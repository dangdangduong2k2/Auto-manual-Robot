...
void robotMovingRotarySpeedSet(double Max)
{
    ...
    Robot.Moving.Rotary.Speed.PID.Output.Min=-Max;
}
///////////////////////////////////////
...
void robotMovingHandleOutput(void)
{
    ...
    DC_Servo_Driver_UART_Speed_Control(1,(int16_t)Robot.Moving.Mecanum.Speed.Total.A);
    DC_Servo_Driver_UART_Speed_Control(2,(int16_t)Robot.Moving.Mecanum.Speed.Total.B1);
    DC_Servo_Driver_UART_Speed_Control(3,(int16_t)Robot.Moving.Mecanum.Speed.Total.B2);    
}